 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gh(t,e,n){let r;return r=t?n&&(n.merge||n.mergeFields)?t.toFirestore(e,n):t.toFirestore(e):e,r}class yh extends mh{constructor(t){super(),this.firestore=t}convertBytes(t){return new Pl(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new Il(this.firestore,null,e)}}function vh(t){t=wl(t,El);const e=wl(t.firestore,Cl),n=Rl(e),r=new yh(e);return ah(t._query),ll(n,t._query).then((n=>new sh(e,r,t,n)))}function wh(t,e,n){t=wl(t,Il);const r=wl(t.firestore,Cl),i=gh(t.converter,e,n);return bh(r,[$l(ql(r),"setDoc",t._key,i,null!==t.converter,n).toMutation(t._key,Qs.none())])}function _h(t,e){const n=wl(t.firestore,Cl),r=kl(t),i=gh(t.converter,e);return bh(n,[$l(ql(t.firestore),"addDoc",r._key,i,null!==t.converter,{}).toMutation(r._key,Qs.exists(!1))]).then((()=>r))}function bh(t,e){return function(t,e){const n=new ti;return t.asyncQueue.enqueueAndForget((async()=>Mu(await cl(t),e,n))),n.promise}(Rl(t),e)}var Ih;!function(t){$r=t}(r.Jn),(0,r.Xd)(new i.wA("firestore",((t,{options:e})=>{const n=t.getProvider("app").getImmediate(),r=new Cl(n,new ri(t.getProvider("auth-internal")));return e=Object.assign({useFetchStreams:!0},e),r._setSettings(e),r}),"PUBLIC")),(0,r.KN)("@firebase/firestore","3.0.2",Ih)},655:function(t,e,n){n.d(e,{ZT:function(){return i},_T:function(){return s},mG:function(){return o},Jh:function(){return a},XA:function(){return c},CR:function(){return u},ev:function(){return l}});
/*! *****************************************************************************
...
//# sourceMappingURL=chunk-vendors.a5615fa0.js.map